    ...
    if (status) {
        ...
        $.ajax({
          ...
          error: function (xhr, ajaxOptions, thrownError) {
            ...
            if (json && typeof json['errors'] === 'object') {
              if (json['errors']['warning']) {
                $('#alert').prepend('<div class="alert alert-danger alert-dismissible"><i class="fa-solid fa-circle-exclamation"></i> ' + json['errors']['warning'] + ' <button type="button" class="btn-close" data-bs-dismiss="alert"></button></div>');
              }
...
$(document).on('click', '[data-oc-toggle=\'image\']', function (e) {
    ...
    var imgmanager_url = $('#imgmanager-url').val()
    var csrf_token = $('input[name="_token"]').val();

    $.ajax({
        url: imgmanager_url + '?csrf_token=' + encodeURIComponent(csrf_token) + '&target=' + encodeURIComponent($(element).attr('data-oc-target')) + '&thumb=' + encodeURIComponent($(element).attr('data-oc-thumb')),
